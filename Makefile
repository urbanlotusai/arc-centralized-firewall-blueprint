...
# Default target
help:
	@echo "Arc Centralized Network Firewall Blueprint - Makefile"
	@echo ""
	@echo "Usage:"
	...
	@echo "  make build-sample  Make the sample verification script executable"
	@echo ""
	@echo "Variables:"
...
# Sanity target — sample-app is a verify.sh script, not a build artifact
build-sample:
	@chmod +x sample-app/verify.sh && echo "sample-app/verify.sh is executable"
